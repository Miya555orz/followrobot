...
> 2026-09-05 安全注记：本文是早期通信 bring-up 记录。当前真实底盘运动仍暂停；Jetson 到 TRON1 只完成 network-only route/ping PASS。后续真机测试必须改走 `docs/TRON1_REAL_TEST_RUNBOOK.md`，不得从本文直接抽取运动命令。
